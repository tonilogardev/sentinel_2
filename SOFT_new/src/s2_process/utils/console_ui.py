...
class PipelineConsoleUI:
    """
    Monitor de Consola usando Rich para mostrar el progreso del pipeline S2-PROCESS.
    ...
    def __init__(self):
        ...
        # Progreso secundario (Sen2Cor / Tareas largas con ETA)
    ...
    def start_pipeline(self, total_stages=7):
        ...
        self.main_task_id = self.main_progress.add_task("Iniciando Pipeline...", total=total_stages)
    ...
    def start_subtask(self, description, total=100.0):
        """Inicia una sub-tarea como Sen2Cor donde mediremos el porcentaje"""
