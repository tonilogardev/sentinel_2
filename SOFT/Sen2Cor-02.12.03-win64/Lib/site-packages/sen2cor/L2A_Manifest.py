...
class L2A_Manifest():
    def __init__(self, config):
        ...
        if config.namingConvention == 'SAFE_STANDARD': 
            self.DICO_IDS = { 
            # PRODUCT ROOT -->
                "S2_Level-2A_Product_Metadata": "S2[ABCD]_OPER_MTD_SAFL2A_PDMC",
                "INSPIRE_Metadata": "INSPIRE.xml",
                "HTML_Presentation": "UserProduct_index.html",
                "HTML_Presentation_Stylesheet": "UserProduct_index.xsl",
            # DATASTRIP -->
                "S2_Level-2A_Datastrip([1-9]?[0-9]{1,6})_Metadata": "S2[ABCD]_OPER_MTD_L2A_DS_",
            # DATASTRIP/QI_DATA -->  
                "Sensor_OLQC_Report_Datastrip([1-9]?[0-9]{1,4})_InformationData":   "S2[ABCD]_OPER_MSI_L1C_DS_.*SENSOR_QUALITY",
                "Geometric_OLQC_Report_Datastrip([1-9]?[0-9]{1,4})_InformationData": "S2[ABCD]_OPER_MSI_L1C_DS_.*GEOMETRIC_QUALITY",
                "General_OLQC_Report_Datastrip([1-9]?[0-9]{1,4})_InformationData": "S2[ABCD]_OPER_MSI_L1C_DS_.*GENERAL_QUALITY",
                "Format_OLQC_Report_Datastrip([1-9]?[0-9]{1,4})_InformationData": "S2[ABCD]_OPER_MSI_L1C_DS_.*FORMAT_CORRECTNESS",
                "Radiometric_OLQC_Report_Datastrip([1-9]?[0-9]{1,4})_InformationData": "S2[ABCD]_OPER_MSI_L1C_DS_.*RADIOMETRIC_QUALITY",
            # GRANULE-->
                "S2_Level-2A_Tile([1-9]?[0-9]{1,6})_Metadata": "S2[ABCD]_OPER_MTD_L2A_TL__........T......_......._......\.xml",
                #"S2_Level-2A_Tile([1-9]?[0-9]{1,6})_Metadata": "S2[ABCD]_OPER_MTD_L2A_TL__20151021T153950_A001515_T53LNA.xml",
            # GRANULE/IMG_DATA -->
                "IMG_DATA_10m_Band[1-4]_Tile([1-9]?[0-9]{1,6})_Data": "S2[ABCD]_OPER_MSI_L2A_TL_.*_B\d\w_10m.jp2",
                "IMG_DATA_20m_Band[1-9]_Tile([1-9]?[0-9]{1,6})_Data": "S2[ABCD]_OPER_MSI_L2A_TL_.*_B\d\w_20m.jp2",
                "IMG_DATA_60m_Band([1-9]|1[0-2])_Tile([1-9]?[0-9]{1,6})_Data": "S2[ABCD]_OPER_MSI_L2A_TL_.*_B\d\w_60m.jp2",
                "AOT_DATA_10m_Tile([1-9]?[0-9]{1,6})_Data": "S2[ABCD]_OPER_AOT_L2A_TL_.*_10m.jp2",
                "AOT_DATA_20m_Tile([1-9]?[0-9]{1,6})_Data": "S2[ABCD]_OPER_AOT_L2A_TL_.*_20m.jp2",
                "AOT_DATA_60m_Tile([1-9]?[0-9]{1,6})_Data": "S2[ABCD]_OPER_AOT_L2A_TL_.*_60m.jp2",
                "WVP_DATA_10m_Tile([1-9]?[0-9]{1,6})_Data": "S2[ABCD]_OPER_WVP_L2A_TL_.*_10m.jp2",
                "WVP_DATA_20m_Tile([1-9]?[0-9]{1,6})_Data": "S2[ABCD]_OPER_WVP_L2A_TL_.*_20m.jp2",
                "WVP_DATA_60m_Tile([1-9]?[0-9]{1,6})_Data": "S2[ABCD]_OPER_WVP_L2A_TL_.*_60m.jp2",
                "VIS_DATA_20m_Tile([1-9]?[0-9]{1,6})_Data": "S2[ABCD]_OPER_VIS_L2A_TL_.*_20m.jp2",
                "VIS_DATA_60m_Tile([1-9]?[0-9]{1,6})_Data": "S2[ABCD]_OPER_VIS_L2A_TL_.*_60m.jp2",
                "SCL_DATA_20m_Tile([1-9]?[0-9]{1,6})_Data": "S2[ABCD]_OPER_SCL_L2A_TL_.*_20m.jp2",
                "SCL_DATA_60m_Tile([1-9]?[0-9]{1,6})_Data": "S2[ABCD]_OPER_SCL_L2A_TL_.*_60m.jp2",
            # GRANULE/QI_DATA -->
                "Sensor_OLQC_Report_Tile([1-9]?[0-9]{1,4})_InformationData": "S2[ABCD]_OPER_MSI_L2A_TL_.*SENSOR_QUALITY",
                "Geometric_OLQC_Report_Tile([1-9]?[0-9]{1,4})_InformationData": "S2[ABCD]_OPER_MSI_L2A_TL_.*GEOMETRIC_QUALITY",
                "General_OLQC_Report_Tile([1-9]?[0-9]{1,4})_InformationData": "S2[ABCD]_OPER_MSI_L2A_TL_.*GENERAL_QUALITY",
                "Format_OLQC_Report_Tile([1-9]?[0-9]{1,4})_InformationData": "S2[ABCD]_OPER_MSI_L2A_TL_.*FORMAT_CORRECTNESS",
            # fix for SIIMPC-734 VD:
                "DefectivePixelsMask_Band([1-9]|1[0-3])_Tile([1-9]?[0-9]{1,6})_Data": "S2[ABCD]_OPER_MSK_DEFECT_.*.jp2", # discard .gfs .gml
                "DetectorFootprintMask_Band([1-9]|1[0-3])_Tile([1-9]?[0-9]{1,6})_Data": "S2[ABCD]_OPER_MSK_DETFOO_.*.jp2", # discard .gfs .gml
                "NodataPixelsMask_Band([1-9]|1[0-3])_Tile([1-9]?[0-9]{1,6})_Data": "S2[ABCD]_OPER_MSK_NODATA_.*.jp2", # discard .gfs .gml
                "SaturatedPixelsMask_Band([1-9]|1[0-3])_Tile([1-9]?[0-9]{1,6})_Data": "S2[ABCD]_OPER_MSK_SATURA_.*.jp2", # discard .gfs .gml
                "TechQualityMask_Band([1-9]|1[0-3])_Tile([1-9]?[0-9]{1,6})_Data": "S2[ABCD]_OPER_MSK_TECQUA_.*.jp2", # discard .gfs .gml
                "QualitPixelsMask_Band([1-9]|1[0-3])_Tile([1-9]?[0-9]{1,6})_Data": "S2[ABCD]_OPER_MSK_QUALIT_.*.jp2",# discard .gfs .gml
            # end fix for SIIMPC-734
                "S2_Level-1C_Preview_Tile([1-9]?[0-9]{1,6})_Data": "S2[ABCD]_OPER_PVI_L1C_TL_.*.jp2",
                "S2_Level-2A_Preview_Tile([1-9]?[0-9]{1,6})_Data": "S2[ABCD]_OPER_PVI_L2A_TL_.*.jp2",
                "CloudMask_Level-1C_Tile([1-9]?[0-9]{1,6})_Data": "S2[ABCD]_OPER_MSK_CLOUDS_.*.gml", # discard .gfs
                "CloudMask_20m_BandTile([1-9]?[0-9]{1,6})_Data": "S2[ABCD]_OPER_CLD_L2A_TL_.*_20m.jp2",
                "CloudMask_60m_BandTile([1-9]?[0-9]{1,6})_Data": "S2[ABCD]_OPER_CLD_L2A_TL_.*_60m.jp2",
                "SnowMask_20m_Tile([1-9]?[0-9]{1,6})_Data": "S2[ABCD]_OPER_SNW_L2A_TL_.*_20m.jp2",
                "SnowMask_60m_Tile([1-9]?[0-9]{1,6})_Data": "S2[ABCD]_OPER_SNW_L2A_TL_.*_60m.jp2",
                "Processing_Report([1-9]?[0-9]{1,6})_InformationData": "S2[ABCD]_OPER_PRD_MSIL2A_.*_report.xml",
            # GRANULE/AUX_DATA -->
                "CAMS_Tile1":"S2[ABCD]_OPER_AUX_CAMS*",
                "ECMWF_Tile1":"S2[ABCD]_OPER_AUX_ECMWF_*",
                "S2_GIP_L2A_Tile([1-9]?[0-9]{1,6})_Metadata": "S2[ABCD]_OPER_GIP_L2A_TL_.*.xml" }
        else:
            self.DICO_IDS = { 
            # PRODUCT ROOT -->
            ...
            # end fix for SIIMPC-734
                ...
                "Processing_Report([1-9]?[0-9]{1,6})_InformationData": "S2[ABCD]_MSIL2A_.*_report.xml",
            # GRANULE/AUX_DATA -->
                "CAMS_Tile1":"AUX_CAMS*",
