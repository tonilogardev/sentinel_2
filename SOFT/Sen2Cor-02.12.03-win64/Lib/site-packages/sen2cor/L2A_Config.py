...
class L2A_Config(object):
    def __init__(self, logger, input_dir=False):
        ...
        self._processorVersion = '02.12.03'
        self._processorDate = '2024.09.09'
    ...
    def createAtmDataFilename(self):
        ...
        try:
            ...
            self.logger.info('look up table for %s found and used' % self._satelliteId) #'S' + self.spacecraftName[-2:]
        ...
        if (productVersion == int(12)):
            ...
            if PSD != 'DEFAULT':
                ...
                if processingBaseline < float32(4.00):
                    ...
                    self.logger.warn('This Processing Baseline {:05.2f} built on PSD 14.x is unknown'.format(processingBaseline))
    ...
    def get_lon_lat(self, xy):
        ...
        lon0, lat0, dummy = transform_utm_to_wgs84(xy[0, 0], xy[0, 1], zone1, zone2)
        lon1, lat1, dummy = transform_utm_to_wgs84(xy[1, 0], xy[1, 1], zone1, zone2)
        lon2, lat2, dummy = transform_utm_to_wgs84(xy[2, 0], xy[2, 1], zone1, zone2)
        lon3, lat3, dummy = transform_utm_to_wgs84(xy[3, 0], xy[3, 1], zone1, zone2)
