...
def S2_Segment_Granules_Download_Function(Segment_2A_2B_2C,AcquisitionDate, folder_out, extractiondir, url, auth_url, username, password, poly_search, granules_orbit, Segment_Orbit, checkTwoDatastrips, granulesToCheckArea, areaForGranulesToCheck, areaThreshold, waiting_list, LastBaseline):
