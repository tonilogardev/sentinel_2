...
##                S2_Parxes_BL_05_11.S2_Parxe2(Segment_Folder) # PARXE
                ...
                try:
                    ...
                    ###
                    ### 07.10.2025 AFEGIM LA GENERACIO DE SCL FEM SERVIR L2A_DEMCAT
                    ###
                    
                    os.chdir(Segment_Folder)
                    compact_date=SearchDateString[0:4]+SearchDateString[5:7]+SearchDateString[8:10]
                    nom_escena = "S2"+Segment_2A_2B_2C+"_SCL_"+Segment_Orbit+"_"+compact_date+"_DEMCAT"
                    resultat_L2A_SCL = S2_L2A_SCL.S2_Segment_Process_L2A_SCL(dir_in, nom_escena, Soft_Geoproces, Soft_GeoprocesGDAL, limits, UTM_Zone_to_reproject)
                    ...
                    try:
                        os.remove("S2"+Segment_2A_2B_2C+"_SCL_"+Segment_Orbit+"_"+compact_date+"_DEMCAT.tif.xml")
                    except:
                        print("File S2"+Segment_2A_2B_2C+"_SCL_"+Segment_Orbit+"_"+compact_date+"_DEMCAT.tif.xml  cannot be removed!\n")
                        sys.stdout.flush()
