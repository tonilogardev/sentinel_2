...
#                   Pere 150125 sembla ser que el proces de checksum ha quedat obsolet ??
#                   possem el valor a  None
                    print('md5_checksum get : ',md5_checksum)
                    md5_checksum = None
                    print('md5_checksum modified : ',md5_checksum)
